...
public enum ErrorCode {
    ...
    REQUEST_TOO_FREQUENT(2005, "Thao tác quá nhanh, vui lòng không spam!", HttpStatus.TOO_MANY_REQUESTS),
    MESSAGE_LIMIT_EXCEEDED(2006, "Vượt quá giới hạn gửi tin!", HttpStatus.TOO_MANY_REQUESTS),
